  ...
  return (
    <div className="relative grid 2xl:grid-cols-2 gap-20 w-full justify-items-center">
      ...
      <div className='relative flex flex-wrap p-24 mx-0 justify-center items-center mt-20 2xl:mt-0 2xl:mr-20 bg-blured rounded-xl scale-75 lg:scale-100'>
        ...
        <div className='absolute w-[250px] h-[250px] -bottom-[270px] sm:-bottom-[82px] sm:-right-[82px] bg-blured-floating flex flex-col justify-center items-center text-center text-2xl sm:text-base'>
          <p className='mb-14'>The founders <br /> consist of</p>
          <p>ABC</p>
          <p>XYZ</p>
        </div>

        <div className="relative w-[432px] h-[432px] rounded-full flex justify-center items-center bg-white bg-opacity-5 border-morph text-2xl lg:text-base">
          ...
          <p className='absolute top-0 left-24 lg:right-auto lg:top-4'>L3: Gold and Platinum Members</p>
        </div>
