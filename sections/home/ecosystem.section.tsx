  ...
  return (
    <div className="relative flex flex-wrap justify-center items-center gap-20 w-full">
      ...
      <div className='relative scale-75 lg:scale-100 flex justify-center items-center'>
        ...
        {/* Floating sections */}
        <div className="absolute w-[250px] h-[250px] -top-[190px] sm:-top-[125px] sm:-left-[82px] 2xl:-left-[125px] flex justify-center items-center gm-hard border-t-4 border-l-4 border-white border-opacity-10">
          <Image src={`/icons/metanode-dao.svg`} alt={`metanode dao logo`} width={200} height={200} />
        </div>
        <div className='absolute w-[250px] h-[250px] -bottom-[270px] sm:-bottom-[82px] sm:-right-[82px] flex flex-col justify-center items-center text-center text-2xl gm-medium gm-border'>
