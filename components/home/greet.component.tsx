...
const Greet = () => {
  return (
    <div className='w-full h-screen relative flex justify-center items-center text-white bg-[url("/bg.png")] bg-cover bg-center bg-no-repeat'>
      ...
      <p className='absolute flex w-fit px-10 h-12 top-52 xl:top-24 xl:left-24 justify-center items-end tracking-[0.5em] font-semibold'>ABOUT US</p>
      ...
      <p className='absolute flex w-fit px-10 h-12 bottom-52 xl:bottom-24 xl:right-24 justify-center items-start tracking-[0.5em] font-semibold'>INTERESTED? </p>
      ...
      <div className='absolute bottom-8 lg:bottom-24 font-thin scale-75'>
